...
function LoadVanillaDBs()
    ...
    LoadFile("SkillTreeGenerator/DB/Core/WH3/MixuGnoblars/character_skill_node_set_items_tables_ab_unwashed_masses.tsv", "character_skill_node_set_items_tables");
